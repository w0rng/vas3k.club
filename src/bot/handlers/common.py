...
COMMENT_URL_RE = re.compile(r"https?://notall.club/[a-zA-Z]+/.+?/#comment-([a-fA-F0-9\-]+)")
POST_URL_RE = re.compile(r"https?://notall.club/[a-zA-Z]+/(.+?)/")
    ...
    if not user:
        if update.callback_query:
            ...
            update.message.reply_text(
                f"😐 Привяжи <a href=\"https://notall.club/user/me/edit/bot/\">бота</a> к профилю, братишка",
